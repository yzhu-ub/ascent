...
void register_builtin() {
  ...
  AscentRuntime::register_filter_type<VTKHCompositeVector>("transforms",
                                                           "composite_vector");
  AscentRuntime::register_filter_type<VTKHVectorComponent>("transforms",
                                                           "vector_component");
  ...
  AscentRuntime::register_filter_type<VTKHVectorMagnitude>("transforms",
                                                           "vector_magnitude");
  ...
  AscentRuntime::register_filter_type<VTKHStreamline>("transforms",
                                                      "streamline");
  AscentRuntime::register_filter_type<VTKHWarpXStreamline>("transforms",
                                                           "warpx_streamline");
  ...
  AscentRuntime::register_filter_type<ADIOS2Compression>("extracts",
                                                         "adios2_comp");
#endif
